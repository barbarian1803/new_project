	...
	function __construct() 
	{
		...
		$this->add_lapp_function(2, _("&Suppliers"),
			"purchasing/manage/suppliers.php?", 'SA_SUPPLIER', MENU_ENTRY);
                ...
                ## MODIFIED_START
                $this->add_rapp_function(2, _("Cheque reminder"),
			"purchasing/cheque_reminder.php?", 'SA_SUPPLIERPAYMNT', MENU_MAINTENANCE);
                $this->add_rapp_function(2, _("PO approval setting"),
			"purchasing/po_approval_seting.php", 'SA_PURCHASEORDER', MENU_MAINTENANCE);
                ## MODIFIED_END
